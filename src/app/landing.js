...
const Landing = () => {
    return(
      ...
      <motion.div animate={{ x:[50, 50, 0], opacity: 1, scale: 1}}
          ...
          <h1 className={`${myFontOutline.className} max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white text-center md:text-start`}>HEY, I&apos;M</h1>
      ...
      <motion.div animate={{ x:[50, 50, 0], opacity: 1, scale: 1}}
                transition={{
                    ...
                    ease: [0.5, 0.71, 1, 1.5],}}
                initial={{opacity:0}}
                className='col-start-1 row-start-4 row-span-1 col-span-7 flex md:justify-start justify-around md:col-start-1 md:col-span-4 px-4 py-4 md:ml-16 xl:gap-0 w-screen mt-10 md:mt-0'>
